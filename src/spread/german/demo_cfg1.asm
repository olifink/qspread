...
* Qjump's standard config block 02 TAB
	 mkcfhead {QSpread Demo Generelles/Fenster},qs_vers
...
* Configuration data
	 ...
	 cfgstrg  fltd,36,{flp1_filter_}

	 cfgstrg  locd,36,{flp1_}
	 cfgstrg  helpf,36,{flp1_Hilfe_}
	 cfgstrg  prtf,36,{flp1_Printer_DeskJet}
	 cfgstrg  prtd,38,{flp1_Printer_}
	 cfgstrg  prti,36,{\init}
	 cfgstrg  prtp,36,{APR1}
	 cfgstrg  extn,5,{_tab}
