...
* text definitions for main window
	 mktits   flag,{QSpread}             ; window flag title
	 mktitl   titl,{QSpread 2003}
...
*
* User functions definitions (also used in digit names and units)
...
* About window text definitions
	 mktext   aver,{Version}
	 mktits   acpr,{Copyright  1992-2003}
