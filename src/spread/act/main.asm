...
jump_files
	...
	dc.l	fil_xsav	; ^V save current sheet
	dc.l	fil_xsas	; ^N save as...
	dc.l	fil_ximp	;    import from file
	dc.l	fil_xexp	;    export to file
	dc.l	fil_scrp	;    block into scrap
	dc.l	fil_mpag	;    mark page
	dc.l	fil_prtp	; ^P print current page
	dc.l	fil_prtb	;    print current block
